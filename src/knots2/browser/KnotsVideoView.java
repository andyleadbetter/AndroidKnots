...
public class KnotsVideoView extends SurfaceView implements MediaPlayerControl {
	private String TAG = "KnotsVideoView";
	...
	public KnotsVideoView(Context context) {
		super(context);
		initKnotsVideoView();
	}

	public KnotsVideoView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initKnotsVideoView();
	}

	public KnotsVideoView(Context context, AttributeSet attrs, int defStyle) {
